...
contract SimpleBattleRPG {
    ...
    // Prices
    uint256 public constant registerPrice = 0.0001 ether;  // registering in game is cheaper ;)
    uint256 public constant commonPrice = 0.001 ether;  // battle round, revive, heal
    ...
    function battle(uint8 _enemyId, uint256 _battleRounds) public payable {
        ...
        uint256 battlePrice = commonPrice * _battleRounds;
    ...
    modifier requirePayment() {
        require(msg.value >= commonPrice, "Minimium payment required!");
        _;
    }
